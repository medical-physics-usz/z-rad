...
class CheckStructures(object):
    ...
    It reads all the patients folders, searches for RS and checks if structures to be resized are in the RS.
    Returns an excel file with a list of structures in RS and indication if a user-define ROI is one of the structures.
    Type: object
    Attributes:
    ...
    def Save(self, inp_mypath_load, dict_check):
        ...
        try:
            ...
            # cell formatting type, green or red background
