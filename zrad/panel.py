...
class MyPanelRadiomics(scrolled.ScrolledPanel):
    ...
    def InitUI(self):
        ...
        rb_dim2 = wx.RadioButton(self, id = 1061, label = '2D', style = wx.RB_GROUP) # 2D analysis, radiobutton - only one option from the group can be selected
        rb_dim3 = wx.RadioButton(self, id =1062,  label = "3D") # 3D analysis
        st_wv = wx.StaticText(self, label = 'Wavelet transform ')
        rb_wvT = wx.RadioButton(self, id = 1071, label = 'On', style = wx.RB_GROUP) # wavelet on, radiobutton - only one option from the group can be selected
        rb_wvF = wx.RadioButton(self, id = 1072,  label = "Off") # wavelet off
        st_s = wx.StaticText(self, label = 'Shape ')
        rb_sT = wx.RadioButton(self, id = 1081, label = 'On', style = wx.RB_GROUP) # shape on, radiobutton - only one option from the group can be selected
        ...
        rb_LNT = wx.RadioButton(self, id = 1091, label = 'On', style = wx.RB_GROUP) # analysis of distribution of LN around PT on, radiobutton - only one option from the group can be selected
